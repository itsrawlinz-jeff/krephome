...
const Header6 = () => {
    ...
    const scrollToPricing = (e) => {
        e.preventDefault();
        const pricingSection = document.querySelector('.home6-pricing-section');
        if (pricingSection) {
    ...
    <div className="sidebar-content">
        <h3>We are KREP Software – Your Trusted Business CRM Partner.</h3>
        <div className="address-area">
            <h5>Nairobi, Kenya</h5>
            <a href="https://www.google.com/maps?q=Mitsumi+Business+Park+Muthithi+Road+Westlands">
                Mitsumi Business Park – Muthithi Road, Westlands
            </a>
        </div>
        <ul className="contact-area">
            <li className="single-contact">
                <div className="icon">
                    <img src="/assets/img/home1/icon/contact-mail-icon.svg" alt="Email Icon" />
                </div>
                <div className="content">
                    <span>Send Us Mail</span>
                    <h6><a href="mailto:support@krepsoft.co.ke">support@krepsoft.co.ke</a></h6>
                </div>
            </li>
            <li className="single-contact">
                <div className="icon">
                    <img src="/assets/img/home1/icon/contact-call-icon.svg" alt="Phone Icon" />
                </div>
                <div className="content">
                    <span>Call 24/7 Hours</span>
                    <h6><a href="tel:+254117888890">+254 117 888 890</a></h6>
                </div>
            </li>
        </ul>
    </div>
    <div className="sidebar-bottom-area">
        <div className="subscribe-area">
            <h5>Subscribe To Get Free Updates</h5>
                ...
                <div className="form-inner2">
                    <div className="form-check">
                        ...
                        <label className="form-check-label" htmlFor="contactCheck">
                            By subscribing, you agree to our <strong>privacy policy.</strong>
                        </label>
                    </div>
                </div>
            </form>
                ...
                <div className="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
                    <div className="company-logo">
                        ...
                        <div className="logo-content">
                            ...
                            <span>Your All-In-One<br /> CRM,HRM & ERP.</span>
                        </div>
                    </div>
                                            ...
                                            <div className="row align-items-lg-end justify-content-between">
                                                <div className="col-xl-7 col-lg-8">
                                                    <div className="title-area">
                                                        <h2>KREP System Features & Solutions</h2>
                                                        <div className="icon">
                                                    ...
                                                    <ul className="menu-row">
                                                        <li className="menu-single-item">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="https://krepsoftware.co.ke/authentication/">
