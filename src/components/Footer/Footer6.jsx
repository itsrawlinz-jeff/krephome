                    ...
                    <div className="row gy-5">
                        ...
                        <div className="col-xl-2 col-lg-3 col-sm-6 d-flex justify-content-lg-end">
                            <div className="footer-widget">
                                ...
                                <ul className="widget-list">
                                    <li><a href="https://krepsoftware.co.ke/authentication/">Contact Sales</a></li>
                                    <li><a href="https://calendly.com/krepsoftware/krep-demo-meeting">Request A Demo</a></li>
                                    <li><a href="https://krepsoftware.co.ke/authentication/">Feedback</a></li>
            ...
            <div className="footer-bottom">
                <div className="container">
                    ...
                    <div className="copyright-and-social-area">
                        <p>Copyright 2025 <a href="https://krepsoftware.co.ke">KREP Software | Yunovia Group</a> | All Right Reserved.</p>
